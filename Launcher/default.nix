    ...
    nugetDeps = linkFarmFromDrvs "${name}-nuget-deps" (map fetchNuGet [
      {
        ...
        version = "6.0.25";
        hash = "sha256-njOrSWL+YJJvnywJ0clMzYdaANYl3rcVaZeZAki1erk=";
      }
      {
        pname = "Microsoft.AspNetCore.App.Runtime.win-arm64";
        version = "6.0.25";
        hash = "sha256-Jnt9WIxGvvejtBW5mjWCXlYmsUj6fxVI4Xs3WWsr8YE=";
      }
      {
        pname = "Microsoft.NETCore.App.Host.win-x64";
        version = "6.0.25";
        hash = "sha256-ATiO6e8xcDPrRngmT9k//7Z2Mx07hJhxgmdwUvMYJA0=";
      }
      {
        pname = "Microsoft.NETCore.App.Host.win-arm64";
        version = "6.0.25";
        hash = "sha256-xvj8CZHY4PyXKroniWj0JIoksKf4pcbberfMf5XZYaE=";
      }
      {
        pname = "Microsoft.NETCore.App.Runtime.win-x64";
        version = "6.0.25";
        hash = "sha256-Lk6cn0cSQVp4QVf6IznE7UnZ9tYxZmRMYrsTIHq9Vg8=";
      }
      {
        pname = "Microsoft.NETCore.App.Runtime.win-arm64";
        version = "6.0.25";
        hash = "sha256-eCoXKCHkrteypFVOUctV3ReQk/lFjJ7cI/CVk2tNrZY=";
      }
      {
        pname = "System.CommandLine";
        version = "2.0.0-beta3.22114.1";
        hash = "sha256-lcqMVesbt2E189e6KfG8HVmJc3hjo2ht48WnH1UaMkY=";
      }
    ]);
